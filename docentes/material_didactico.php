...
if(isset($_SESSION['user'])) {
     if ($_SESSION["nivel"] == 2) {
         ...
         $consultaU = "SELECT idNumAsignacion, numeroAsignado FROM numeroasignaciones";
         $numero=mysqli_query($conexion,$consultaU);
     }
...
<body>
 ...
 <br>
    ...
    <?php
          /*include('../admin/conexion.php');
          $numeroMaterial = $_SESSION["idMaterial"]
          $numeroRegistros = mysqli_num_rows(mysqli_query("SELECT * FROM materialdidactico where idMaterial = '$numeroMaterial'"));
